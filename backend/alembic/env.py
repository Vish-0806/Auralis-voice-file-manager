...
def compile_jsonb_sqlite(type_, compiler, **kw):
    """Compiles JSONB as JSON under SQLite to support developer testing and schema verification."""
    return "JSON"

# Import our models metadata
from memory.database.base import Base
import memory.orm  # ensures all models register with Base.metadata
